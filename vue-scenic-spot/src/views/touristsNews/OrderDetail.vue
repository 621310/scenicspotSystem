...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            goPay(){
                console.log(this.orderDetail.code)
                sessionStorage.setItem("WIDout_trade_no",this.orderDetail.code)
                sessionStorage.setItem("WIDtotal_amount",this.orderDetail.total)
